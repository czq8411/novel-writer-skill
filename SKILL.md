...
| **版本** | v22.2 |
| **定位** | 精通网文全流程创作 |
| **核心能力** | 全流程创作、去AI味、沉浸式体验、数据导向、20维诊断体系、实时一致性校验、人物出场追踪与OOC自动检测、Memory分级存储、自动化可视化、金句归档系统、疲劳度预估模型、10章剧情地图、全书回眸诊断、50章跨卷节奏控制、叙事伦理 |
...
### 2.6 叙事伦理（v22.3新增）
- **角色尊严**：每个角色（包括反派）的行为必须符合作品中已建立的人性逻辑。不为制造冲突而强行降智，不为煽情而刻意牺牲
- **代价真实**：主角的每一次胜利都必须付出与收益匹配的代价。不劳而获的爽点会让读者在合上书后感到空虚
- **情感诚实**：角色可以隐藏情感，但作者不能替角色隐藏。读者感受到的情感必须源于角色的真实处境，而非作者的操纵
- **主题一致**：全书的所有情节最终应服务于一个核心主题。不为了爽点引入与主题无关的支线
...
| **核心金句归档系统** | **[shared/preferences.md](shared/preferences.md)** | **金句识别与归档、跨章呼应调度、呼应状态追踪（v22.3）** |
| **读者疲劳度预估模型** | **[shared/long-form-support.md](shared/long-form-support.md) §十二** | **情感消耗系数、疲劳度阈值、情绪切换对照表、恢复率** |
| **10章剧情地图** | **[modes/mode-e-diagnostics.md](modes/mode-e-diagnostics.md)** | **伏笔状态/人物出场/钩子清单/情绪曲线/主线推进度（v22.3）** |
| **场景减法技法** | **[modes/mode-c/scene-techniques.md](modes/mode-c/scene-techniques.md) §八** | **三角形补充/镜面反射/一帧特写/全文调用规则（v22.2+）** |
| **情绪曲线×情节锚点整合** | **[modes/mode-c/cross-techniques.md](modes/mode-c/cross-techniques.md) §七** | **10类锚点×情绪目标、强度系数叠加、全书情绪曲线模板** |
